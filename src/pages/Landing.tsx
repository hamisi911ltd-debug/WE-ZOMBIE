      ...
      <nav className="public-nav">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo.jpeg" alt="Immacurate Driving School" className="h-12 rounded" />
          </Link>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-6 text-lg leading-relaxed text-blue-100">
                Immacurate Driving School offers professional driver training for all licence categories.
                Located at Juja Arcade, 1st Floor, Kalimoni. Our certified instructors guide you from 
                beginner to road-ready with structured courses and flexible scheduling.
              </p>

              <div className="mt-8 flex flex-wrap gap-4">
                <Link to={isAuthenticated ? "/dashboard" : "/login"} className="btn-brand" style={{ padding: "0.875rem 2rem", fontSize: "1rem" }}>
                  {isAuthenticated ? "Go to My Portal" : "Student Login"}
              ...
              >
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { icon: CreditCard, label: "Payment Due: KES 45,000", sub: "Due in 5 days", color: "#60a5fa" },
                  ].map((item) => (
                    <div
                      key={item.label}
      ...
      <section id="courses" className="py-20">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: "Class B – Light Motor Vehicle",
                tag: "Most Popular",
                tagColor: "#8b1a1a",
                desc: "Standard car licence for private vehicles. Comprehensive theory and practical training covering all road rules and vehicle control.",
                features: ["Theory lessons", "Practical training", "Test preparation"],
                price: "KES 14,300",
                color: "#8b1a1a",
              },
              {
                title: "Class C – Medium Goods Vehicle",
                tag: "Professional",
                tagColor: "#1e3a8a",
                desc: "Medium goods vehicle licence. Perfect for those pursuing careers in transport and logistics.",
                features: ["Advanced theory", "Practical hours", "Route planning"],
                price: "KES 15,300",
                color: "#1e3a8a",
              },
              {
                ...
                tag: "Popular",
                tagColor: "#d97706",
                desc: "Motorcycle licence for all types of motorcycles. Learn safe riding techniques and road awareness.",
                features: ["Safety training", "Practical riding", "Test included"],
                price: "KES 9,200",
                color: "#d97706",
              },
            ].map((course) => (
              <div key={course.title} className="feature-card flex flex-col">
                ...
                <div className="mt-6 flex items-center justify-between">
                  ...
                  >
                    {isAuthenticated ? "View Course" : "Contact Us"} <ChevronRight className="size-4" />
                  </Link>
                </div>
              </div>
            ))}
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 font-display text-4xl font-black text-gray-900">
                The Immacurate Driving School Difference
              </h2>
      ...
      >
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-blue-100">
            Contact us today to enroll. Our team will guide you through the registration process
            and help you choose the right course for your needs.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 font-display text-4xl font-black text-gray-900">
                Contact Immacurate Driving School
              </h2>
              ...
              <div className="mt-8 space-y-4">
                {[
                  { icon: Phone, label: "0721 171911", sub: "Mon–Sat, 8am–6pm" },
                  { icon: Mail, label: "immacuratedriving77@gmail.com", sub: "We reply within 24 hours" },
                  { icon: MapPin, label: "Juja Arcade, 1st Floor", sub: "P.O Box 717-01001 Kalimoni" },
                ].map((item) => (
        ...
        <div className="mx-auto max-w-7xl px-6 py-12">
          <div className="grid gap-8 md:grid-cols-4">
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-blue-200 max-w-xs">
                Learn with the best. Professional driver training since 2014.
              </p>
            </div>
            <div>
          ...
          <div className="mt-10 border-t pt-6" style={{ borderColor: "rgba(255,255,255,0.10)" }}>
            <p className="text-center text-sm text-blue-300">
              © {new Date().getFullYear()} Immacurate Driving School. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
